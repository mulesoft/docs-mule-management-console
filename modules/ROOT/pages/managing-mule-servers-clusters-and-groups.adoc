...
To learn how to register or unregister a server, see xref:setting-up-mmc-mule-esb-communications.adoc[Setting Up MMC-Mule ESB Communications]. To learn how to monitor servers, including viewing operational and performance details of individual servers, see the relevant pages in the left navigation bar. To learn how to create or disband clusters of Mule servers, see xref:creating-or-disbanding-a-cluster.adoc[Creating or Disbanding a Cluster].

== Assumptions

This document assumes that you are familiar with the basic xref:architecture-of-the-mule-management-console.adoc[Architecture of the Mule Management Console], and that you have installed the xref:installing-the-production-version-of-mmc.adoc[production] version of MMC. Also, ideally there should be at least one active Mule instance that you can control from your installed MMC.
...
For an explanation of the *Server Details* pane, see the relevant pages under xref:monitoring-a-server.adoc[Monitoring a Server].
...
* Learn how to create and manage xref:creating-or-disbanding-a-cluster.adoc[High Availability (HA) clusters] of Mule servers.
* Learn how to xref:deploying-applications.adoc[deploy applications] to Mule servers.
* Learn how to xref:monitoring-a-server.adoc[monitoring an individual server] with MMC.