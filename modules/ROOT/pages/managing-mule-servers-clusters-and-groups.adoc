...
To learn how to register or unregister a server, see xref:3.7@setting-up-mmc-mule-esb-communications.adoc[Setting Up MMC-Mule ESB Communications]. To learn how to monitor servers, including viewing operational and performance details of individual servers, see the relevant pages in xref:3.6@managing-with-mmc.adoc[Managing with MMC]. To learn how to create or disband clusters of Mule servers, see xref:3.4@creating-or-disbanding-a-cluster.adoc[Creating or Disbanding a Cluster].

== Assumptions

This document assumes that you are familiar with the basic xref:3.6@architecture-of-the-mule-management-console.adoc[Architecture of the Mule Management Console], and that you have installed the xref:3.6@installing-the-production-version-of-mmc.adoc[production] version of MMC. Also, ideally there should be at least one active Mule instance that you can control from your installed MMC.
...
image::new-server-list.png[NEW-server_list]
...
For an explanation of the *Server Details* pane, see the relevant pages under xref:3.7@monitoring-a-server.adoc[Monitoring a Server].
...
image::new-stop-restar-server.png[NEW-stop-restar_server]
...
* Learn how to create and manage xref:3.7@creating-or-disbanding-a-cluster.adoc[High Availability (HA) clusters] of Mule servers.
* Learn how to xref:3.6@deploying-applications.adoc[deploy applications] to Mule servers.
* Learn how to xref:3.7@monitoring-a-server.adoc[monitoring an individual server] with MMC.