...
This document, as well as the rest of the documents that make up the xref:3.4@rest-api-reference.adoc[Mule Management Console REST API Reference Guide], are a technical reference only. This document does not provide contextual information such as instructions, use cases or scenarios. To understand this document, you should be familiar with Mule Runtime, User Groups, and the xref:3.4@using-the-management-console-api.adoc[REST API].
...
|===
|Key |Type |Summary |Child of
|userGroupName |String |Name of the server group to be listed. Invoke xref:3.4@user-groups.adoc[LIST ALL] to obtain it. |--
|===
...
|===
|Key |Type |Summary |Child of
|userGroupName |String |Name of the User Group to be removed. Invoke xref:3.4@user-groups.adoc[LIST ALL] to obtain it. |--
|===
