...
xref:managing-servers-using-rest-apis.adoc[<< Previous: *Managing Servers Using REST APIs*]

xref:managing-applications-using-rest-apis.adoc[Next: *Managing Applications Using REST APIs*] >>