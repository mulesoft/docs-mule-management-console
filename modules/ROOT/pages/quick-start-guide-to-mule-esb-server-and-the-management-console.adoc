...
[TIP]
To evaluate Mule high availability clustering, see xref:3.3@mule-runtime::evaluating-mule-high-availability-clusters-demo.adoc[Evaluating Mule HA Clustering].
