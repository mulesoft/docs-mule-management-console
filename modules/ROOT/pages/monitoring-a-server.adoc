...
*[mmc:Mule 3.2]* You can also use the management console to monitor a cluster. A cluster is a set of Mule instances that acts as a unit. See xref:monitoring-a-cluster.adoc[Monitoring a Cluster] for details.
...
xref:accessing-server-logs.adoc[<< Previous: *Accessing Server Logs*]
