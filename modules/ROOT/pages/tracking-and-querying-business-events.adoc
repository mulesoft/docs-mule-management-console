...
In the metadata you set for custom events, you can make use of fine-grained xref:3.2@mule-runtime::expressions-configuration-reference.adoc[expression language], as shown below.
...
image::event-search-multi-keys.png[]
...
image::filtered-search-results.png[]
...
xref:analyzing-business-events.adoc[<< Previous: *Analyzing Business Events*]

xref:business-events-use-cases.adoc[Next: *Business Events Use Cases* >>]