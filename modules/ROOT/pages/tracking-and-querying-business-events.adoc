...
[NOTE]
Note that you can customize the transaction Id in your Mule application to make it more meaningful. See xref:3.3@mule-runtime::business-events.adoc[Business Events] for more details.
