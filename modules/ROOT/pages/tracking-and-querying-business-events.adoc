...
[NOTE]
====
Note that you can customize the transaction Id in your Mule application to make it more meaningful. See https://docs.mulesoft.com/mule-user-guide/v/3.6/business-events[Business Events] for more details.
====
