...
* xref:defining-slas-and-alerts.adoc[Creating an Alert Definition]
* xref:defining-slas-and-alerts.adoc[Editing an Alert Definition]
* xref:defining-slas-and-alerts.adoc[Alert Data Fields]
* xref:defining-slas-and-alerts.adoc[Common Alert Fields]
* xref:defining-slas-and-alerts.adoc[Custom Alert Type Fields]
* <<exception-alert-type-fields,Exception Alert Type Fields>>
* xref:defining-slas-and-alerts.adoc[Properties Used in Alert Expressions]
...
Custom alerts are executed as Groovy script snippets. The execution context is exactly the same as for other scripts in Mule. The context bindings for these scripts are described in https://docs.mulesoft.com/mule-user-guide/v/3.7/scripting-module-reference#sts=Script%20Context%20Bindings[Script Context Bindings].
