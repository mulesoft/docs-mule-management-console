...
* xref:3.7@defining-slas-and-alerts.adoc[Creating an Alert Definition]
* xref:3.7@defining-slas-and-alerts.adoc[Editing an Alert Definition]
* xref:3.7@defining-slas-and-alerts.adoc[Alert Data Fields]
* xref:3.7@defining-slas-and-alerts.adoc[Common Alert Fields]
* xref:3.7@defining-slas-and-alerts.adoc[Custom Alert Type Fields]
* <<Exception Alert Type Fields>>
* xref:3.7@defining-slas-and-alerts.adoc[Properties Used in Alert Expressions]
...
image::alerts-custom-expression.png[]
...
Custom alerts are executed as Groovy script snippets. The execution context is exactly the same as for other scripts in Mule. The context bindings for these scripts are described in https://docs.mulesoft.com/mule-user-guide/v/3.5/scripting-module-reference#script-context-bindings[Script Context Bindings].
