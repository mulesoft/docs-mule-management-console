...
image::properties-top.png[]

xref:working-with-the-server-configuration-files.adoc[<< Previous: *Working with the Server Configuration Files*]

xref:viewing-server-os-resources.adoc[Next: *Viewing Server OS Resources* >>]