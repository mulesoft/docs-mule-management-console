...
This walkthrough assumes that you are familiar with xref:3.4@mule-runtime::mule-concepts.adoc[Mule applications and Mule flows] and that you have downloaded and installed **Mule ESB Enterprise Runtime (with Management Tools)** which includes a *trial version* of the Mule Management Console. Beyond installation, you do not need to complete any specific setup configurations to complete this walkthrough.
