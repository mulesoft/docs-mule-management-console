...
For the MMC production version, you must first deploy MMC to your application server and start the MMC application. For instructions deploying MMC to different application servers, see the xref:installing-the-production-version-of-mmc.adoc[installation documentation].
