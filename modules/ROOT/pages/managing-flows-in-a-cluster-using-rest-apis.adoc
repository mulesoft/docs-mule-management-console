...
xref:managing-flows-in-a-server-using-rest-apis.adoc[<< Previous: *Managing Flows in a Server Using REST APIs*]

xref:using-the-management-console-for-performance-tuning.adoc[Next: *Using the Management Console for Performance Tuning*] >>