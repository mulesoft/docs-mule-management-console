...
image::add-new-cluster-menu-1.png[add_new_cluster_menu-1]
...
image::flows-mainpage.png[]

See xref:working-with-flows.adoc[Working with Flows] for more details on working with flows.
...
image::audit-pane.png[]

See xref:working-with-flows.adoc[Working with Flows] for more details on auditing and analyzing flows and services.
...
See xref:managing-users-and-roles.adoc[Managing Users and Roles] for more details on administering users. +
See xref:automating-tasks-using-scripts.adoc[Automating Tasks Using Scripts] to get started with utility scripts.

xref:how-to-run-the-management-console.adoc[<< Previous: *How to Run the Management Console*]

xref:quick-start-guide-to-mule-esb-server-and-the-management-console.adoc[Next: *Quick Start Guide to Mule ESB Server and the Management Console* >>]