...
* xref:3.2@mule-runtime::routing-message-processors.adoc[Using Message Processors to Control Message Flow] - Provides reference information for the available Mule message processors or routers.
...
image::audit-msg-properties.png[]
...
xref:working-with-flows.adoc[<< Previous: *Working with Flows*]

xref:working-with-alerts.adoc[Next: *Working with Alerts* >>]