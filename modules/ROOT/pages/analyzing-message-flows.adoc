...
See xref:3.3@mule-runtime::routing-message-processors.adoc[Using Message Processors to Control Message Flow] to find out more about these standard message processors and how to use them to control message flow.
