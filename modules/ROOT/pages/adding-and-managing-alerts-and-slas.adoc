...
See xref:setting-up-alert-destinations-and-notifications.adoc[Setting Up Alert Destinations] for details on setting up other email destinations.
...
xref:monitoring-and-debugging-applications.adoc[Next: *Monitoring and Debugging Applications* >>]