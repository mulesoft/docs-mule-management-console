...
You can also create and disband clusters programmatically using REST APIs. See xref:managing-clusters-using-rest-apis.adoc[Managing Clusters Using REST APIs].
