...
* xref:3.6@customizing-the-dashboard.adoc[Customizable Dashboard]
* xref:3.6@customizing-the-dashboard.adoc[Viewing the Custom Dashboard]
* xref:3.6@customizing-the-dashboard.adoc[Customizing the Dashboard Display]
...
Note that you can have more than one version of the same portlet displayed on the dashboard. For example, you might want two Server Metrics portlets to appear and have each portlet display a different metric chart. (See xref:3.6@customizing-server-metrics-dashboard.adoc[Customizing the Server Metrics Dashboard] for more information on the server dashboard metrics charts and customizing them.)
