...
This section assumes that you have a clear picture of what
 xref:architecture-of-the-mule-management-console.adoc[what MMC is for] and that you have already xref:installing-mmc.adoc[installed the Management Console] in your machine.
