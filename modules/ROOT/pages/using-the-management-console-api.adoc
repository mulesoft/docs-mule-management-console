...
For details on these operations, see xref:managing-servers-using-rest-apis.adoc[Managing Servers Using REST APIs].

*[mmc:Mule 3.2]* In addition, you can use the REST APIs to:

* Create or remove a cluster and get information about a cluster, as well as start, stop, and restart applications on a cluster. For details see xref:managing-clusters-using-rest-apis.adoc[Managing Clusters Using REST APIs].
* Find, upload, and delete applications inside the repository. For details see xref:managing-applications-using-rest-apis.adoc[Managing Applications Using REST APIs].
* Deploy, undeploy, create, update, and delete deployments inside a server or cluster. For details see xref:managing-deployments-using-rest-apis.adoc[Managing Deployments Using REST APIs].
* Manage flows, including finding, starting, and stopping flows as well as finding, starting, and stopping a flow's endpoints. For details about managing flows in a server see xref:managing-flows-in-a-server-using-rest-apis.adoc[Managing Flows in a Server Using REST APIs]. For details about managing flows in a cluster see xref:managing-flows-in-a-cluster-using-rest-apis.adoc[Managing Flows in a Cluster Using REST APIs].
...
If you are programming in Java, it's recommended that you use the [Jersey client. Or, for JSON support, use the http://hc.apache.org/httpclient-3.x/index.html[HttpClient] with https://github.com/FasterXML/jackson[Jackson], the high-performance JSON processor.
...
xref:managing-servers-using-rest-apis.adoc[Next: *Managing Servers Using REST APIs*] >>