...
This page describes the Alerts screen that is specific to a particular server. See the xref:working-with-alerts.adoc[Viewing Alerts] page for complete details on defining and managing alerts.
...
image::alert-server.png[]

xref:monitoring-applications.adoc[<< Previous: *Monitoring Applications*]

xref:viewing-system-memory.adoc[Next: *Viewing System Memory* >>]