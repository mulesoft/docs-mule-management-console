...
This document assumes that you have xref:installing-mmc.adoc[downloaded and installed] either the production version of the *Mule Management Console*.
...
This document also assumes that you are familiar with xref:3.4@mule-runtime::mule-concepts.adoc[Mule applications and Mule flows].
