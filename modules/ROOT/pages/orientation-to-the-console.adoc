...
This document assumes that you have xref:installing-mmc.adoc[downloaded and installed] the production version of the  *Mule Management Console*.
...
This document also assumes that you are familiar with  https://docs.mulesoft.com/mule-user-guide/v/3.7/mule-concepts[Mule applications and Mule flows] .
