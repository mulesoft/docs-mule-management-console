...
If you are upgrading to MMC 3.6.0, and your current MMC installation is configured to xref:3.4@setting-up-and-managing-users-via-ldap.adoc[manage users via LDAP], you will need to migrate your existing LDAP configuration to your new MMC 3.6.0 installation.
...
* Learn how to xref:upgrading-to-mmc-3.6.0-with-an-external-database.adoc[upgrade to MMC 3.6.0 with an external database].