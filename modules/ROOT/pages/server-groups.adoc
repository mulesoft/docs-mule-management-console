...
Note that this syntax is an example. Be sure to replace +http://localhost:8080/mmc-console-3.7.3+ with your own MMC hostname, port number, and setting for mmc-console-3.7.3 (which is usually the name of the deployed mmc .war file).
...
[discrete]
==== Using CURL on Windows
Note that this syntax is an example. Be sure to replace +http://localhost:8080/mmc-console-3.7.3+ with your own MMC hostname, port number, and setting for mmc-console-3.7.3 (which is usually the name of the mmc .war file).
