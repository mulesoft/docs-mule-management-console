...
. Download and unpack the user password encryption tools. When you unpack it, the file expands to a directory with two files, `mmc-encrypter-1.0.jar` and `autorun.groovy.script`.
