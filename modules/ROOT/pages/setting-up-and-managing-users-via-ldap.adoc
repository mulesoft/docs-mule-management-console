...
* OS: Linux (Xubuntu 12.04 LTS, based on Debian 7 “Wheezy/Sid”). Homepage: http://xubuntu.org[xubuntu.org]
* LDAP Server: OpenLDAP. Homepage: http://www.openldap.org[openldap.org]
* LDAP browser: Apache Directory Studio. Homepage: http://directory.apache.org/studio/[apache.org/studio]
...
Additionally, several third-party, prepackaged versions are available for download. Of these, the https://downloads.symas.com/[Symas Corporation] includes a paid version for Microsoft Windows.
...
in http://directory.apache.org/studio/users-guide/apache_directory_studio/download_install.html[Apache Directory Download Install] and more information in the  http://directory.apache.org/studio/users-guide/Apache_Directory_Studio_User_Guide.pdf[Apache Directory User Guide (pdf)].
