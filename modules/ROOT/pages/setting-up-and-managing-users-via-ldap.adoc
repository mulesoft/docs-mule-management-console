...
. In the *=* field, enter *groups*. When you do so, the *DN Preview* window fills automatically with teh *Distinguished Name* of the entry you are creating, in this case `ou=groups,dc=company,dc=com`.
...
===== Creating and Defining Administrator Groups
...
* Learn how to xref:setting-up-and-managing-users-via-ldap.adoc[encrypt the MMC LDAP password].