...
For more details about how to define and enable custom or default events in your Mule application, see https://docs.mulesoft.com/mule-user-guide/v/3.7/business-events[Business Events].
