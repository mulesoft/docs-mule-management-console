= Upgrading to MMC 3.6.0 with an External Database
...
[NOTE]
If your current installation of MMC xref:setting-up-and-managing-users-via-ldap.adoc[uses LDAP for managing users], you will also need to migrate your LDAP configuration. See xref:upgrading-to-mmc-3.6.0-with-ldap.adoc[Upgrading to MMC 3.6.0 with LDAP] for details.
...
* Learn how to xref:upgrading-to-mmc-3.6.0-with-ldap.adoc[upgrade to MMC 3.5.0 with LDAP].