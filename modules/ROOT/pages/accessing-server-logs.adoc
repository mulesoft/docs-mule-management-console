...
For complete information on log files, see xref:working-with-logs.adoc[Working with Logs].
...
image::log-folder.png[]

xref:working-with-mule-server-instances.adoc[<< Previous: *Working with Mule Server Instances*]

xref:monitoring-a-server.adoc[Next: *Monitoring a Server* >>]