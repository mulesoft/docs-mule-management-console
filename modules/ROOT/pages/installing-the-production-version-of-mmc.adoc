...
====
+
. If your xref:3.8@mule-runtime::deployment-scenarios.adoc[Mule ESB instance is packaged as a Web app] (not recommended), please open a support case at: https://support.mulesoft.com[https://support.mulesoft.com] for special instructions.
