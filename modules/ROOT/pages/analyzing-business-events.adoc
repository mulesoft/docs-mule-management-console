...
See xref:tracking-and-querying-business-events.adoc[Tracking and Querying Business Events] for details on how to use the transaction and event querying and filtering features. That page also explains how you can add your own custom code to your application to enhance default event tracking.

Also see xref:business-events-use-cases.adoc[Business Events Use Cases] for detailed examples that illustrate the use of the Business Events tab in a business-oriented setting.

xref:analyzing-flow-processing-and-payloads.adoc[<< Previous: *Analyzing Flow Processing and Payloads*]

xref:tracking-and-querying-business-events.adoc[Next: *Tracking and Querying Business Events* >>]