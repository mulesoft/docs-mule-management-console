...
This page introduces the Business Events tab in Mule Management Console and walks through some examples of how to use this tab to monitor and track business events at runtime. For more information about setting up your application to enable tracking of custom and default business events, see the https://docs.mulesoft.com/mule-user-guide/v/3.5/business-events[Business Events] page.
...
* See xref:3.5@tracking-and-querying-business-events.adoc[Tracking and Querying Business Events] for details on how to use the transaction and event querying and filtering features.
* See xref:3.5@business-events-use-cases.adoc[Business Events Use Cases] for detailed examples that illustrate the use of the Business Events tab in a business-oriented setting.
* See https://docs.mulesoft.com/mule-user-guide/v/3.5/business-events[Business Events] to learn about setting up business events in your Mule applications.