...
This page provides examples of using xref:3.7@automating-tasks-using-scripts.adoc[scripts]. You can copy and modify these example scripts for your own use. The scripts include placeholders where you must substitute your own values or parameters.
