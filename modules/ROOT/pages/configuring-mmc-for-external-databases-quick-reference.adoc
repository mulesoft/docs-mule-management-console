...
* xref:3.6@persisting-mmc-data-to-postgresql.adoc[PostgreSQL]
* xref:3.6@persisting-mmc-data-to-oracle.adoc[Oracle]
* xref:3.7@persisting-mmc-data-to-mysql.adoc[MySQL]
* xref:3.6@persisting-mmc-data-to-ms-sql-server.adoc[MS-SQL Server]
