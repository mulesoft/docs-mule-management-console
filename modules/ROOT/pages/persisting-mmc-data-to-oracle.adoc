...
This document assumes that you have an understanding of the basic xref:architecture-of-the-mule-management-console.adoc[Architecture of the Mule Management Console].
...
.. Run `tables_oracle.sql` using the `sqlplus` utility, and complete one of the following steps depending on your operating system: +
...
. Replace the appropriate parameters to use Oracle instead of the default Derby database. A full listing of the modified file is provided below.
