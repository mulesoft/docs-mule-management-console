...
xref:viewing-jmx-information.adoc[<< Previous: *Viewing JMX Information*]

xref:customizing-server-metrics-dashboard.adoc[Next: *Customizing Server Metrics Dashboard* >>]