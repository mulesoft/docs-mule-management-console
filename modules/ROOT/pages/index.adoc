= Mule Management Console (v3.6 Archives)
...
* A https://docs.mulesoft.com/mule-user-guide/v/3.6/downloading-and-starting-mule-esb[Mule ESB Enterprise] instance with a valid https://docs.mulesoft.com/mule-user-guide/v/3.6/installing-an-enterprise-license[enterprise license]
* The MMC console application file (mmc.war) deployed in a https://docs.mulesoft.com/mule-user-guide/v/3.6/hardware-and-software-requirements[supported web application server]
