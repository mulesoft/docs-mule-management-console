= Mule Management Console (v3.7 Archives)
...
* A xref:3.4@mule-runtime::downloading-and-launching-mule-esb.adoc[Mule ESB Enterprise] instance with a valid xref:3.4@mule-runtime::installing-an-enterprise-license.adoc[enterprise license]
* The MMC console application file (mmc.war) deployed in a xref:3.4@mule-runtime::hardware-and-software-requirements.adoc[supported web application server]
