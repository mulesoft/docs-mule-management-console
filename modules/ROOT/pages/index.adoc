= Mule Management Console (v3.5 Archives)
...
[cols="25a,75a"]
|===
|image:icon-government-blue-100px.png[]
...
|image:icon-datamapper-blue-100px.png[]
...
|image:icon-lock-blue-big-100px.png[]
...
|image:icon-dashboard-blue-100px.png[]
...
|image:icon-alert-blue-100px.png[]
...
|image:icon-graph-blue-100px.png[]
...
|image:icon-stopwatch-blue-100px.png[]
...
* A https://docs.mulesoft.com/mule-user-guide/v/3.5/downloading-and-starting-mule-esb[Mule ESB Enterprise] instance with a valid https://docs.mulesoft.com/mule-user-guide/v/3.5/installing-an-enterprise-license[enterprise license]
* The MMC console application file (mmc-3.7.0.war) deployed in a https://docs.mulesoft.com/mule-user-guide/v/3.5/hardware-and-software-requirements[supported web application server]
