...
For more information on starting Mule with custom parameters, see https://docs.mulesoft.com/mule-user-guide/v/3.6/starting-and-stopping-mule-esb[Starting and Stopping Mule].
====
