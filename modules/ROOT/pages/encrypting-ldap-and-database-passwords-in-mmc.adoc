...
This document assumes that you are familiar with the basic https://docs.archive.mulesoft.com/mule-management-console/v/3.7/architecture-of-the-mule-management-console[Architecture of the Mule Management Console]. It also assumes that you have installed MMC version 3.5.0. (Download it from the http://www.mulesoft.com/support-login[customer portal] if you need to upgrade to this version.)
...
For more information on starting Mule with custom parameters, see xref:3.8@mule-runtime::starting-and-stopping-mule-esb.adoc[Starting and Stopping Mule ESB].
====
...
* Learn how to https://docs.archive.mulesoft.com/mule-management-console/v/3.3/enabling-ldap-authentication[enable LDAP Authentication] for MMC