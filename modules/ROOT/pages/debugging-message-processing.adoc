...
To see an actual example of using the console to find a bug in the application logic, see xref:3.6@debugging-the-loan-broker-example-application.adoc[Debugging the Loan Broker Example Application].
