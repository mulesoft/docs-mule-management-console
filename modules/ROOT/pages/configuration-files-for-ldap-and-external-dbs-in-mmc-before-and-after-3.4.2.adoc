...
.2+|MMC_HOME/WEB-INF/classes/META-INF/databases/tracking-persistence-DATABASE_NAME.properties
Where DATABASE_NAME is the DB server name, such as oracle or postgres.
